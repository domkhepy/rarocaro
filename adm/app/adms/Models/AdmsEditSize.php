...
/**
 * A classe AdmsEditSize recebe as informações que serão editadas no banco de dados
 *
 * @author Domingos
 */
class AdmsEditSize
{
    ...
    /**
     * Método para fazer busca do Id na tabela sts_size e validar o mesmo
    ...
    private function edit() {
        ...
        $upAccessLevel->exeUpdate("sts_sizes", $this->dados, "WHERE id =:id", "id={$this->dados['id']}");
