...
/**
 * A classe AdmsAddProvince recebe as informações que serão enviadas para o banco de dados
 *
 * @author Domingos
 */
class AdmsAddProvince
{
    ...
    private function add() {
            ...
            $createAccessLevel->exeCreate("sts_provinces", $this->dados);
