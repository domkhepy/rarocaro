...
<div class="content p-1">
    <div class="list-group-item">
        ...
        <form id="edit_img" method="POST" action="" enctype="multipart/form-data">
            ...
            <?php
            if (isset($valorForm['image']) AND (!empty($valorForm['image'])) AND (file_exists('app/adms/assets/image/categories/' . $valorForm['id'] . '/' . $valorForm['image']))) {
                $old_image = URLADM . 'app/adms/assets/image/categories/' . $valorForm['id'] . '/' . $valorForm['image'];
            } else {
                $old_image = URLADM . 'app/adms/assets/image/categories/category_icon.jpg';
            }
            ?>
            ...
            <input name="EditCategoriesImagem" type="submit" class="btn btn-outline-warning btn-sm" value="Salvar"> 
