    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 title">Detalhes da Provincia</h2>
            </div>
            <?php
            if (!empty($this->dados['viewProvince'])) {
                extract($this->dados['viewProvince'][0]);
                ?>
                <div class="p-2">
                    ...
                    <div class="dropdown d-block d-lg-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                            ...
                            if ($this->dados['button']['list_province']) {
                                echo "<a class='dropdown-item' href='" . URLADM . "list-province/index'>Listar</a>";
                            }
                            if ($this->dados['button']['edit_province']) {
