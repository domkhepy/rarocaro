    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 title">Editar Província</h2>
            </div>
            <?php
            if (!empty($valorForm)) {
                extract($valorForm);
                ...
                <div class="p-2">
                    <span class="d-none d-lg-block">
                        <?php
                        if ($this->dados['button']['list_provinces']) {
                            echo "<a href='" . URLADM . "list-provinces/index' class='btn btn-outline-info btn-sm'>Listar</a> ";
                        }
                    ...
                    <div class="dropdown d-block d-lg-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                            <?php
                            if ($this->dados['button']['list_province']) {
                                echo "<a class='dropdown-item' href='" . URLADM . "list-provinces/index'>Listar</a>";
                            }
                            if ($this->dados['button']['view_province']) {
        ...
        ?>
        <form id="form_province" method="POST" action="">
            ...
            <input name="EditProvince" type="submit" class="btn btn-outline-warning btn-sm" value="Salvar"> 
