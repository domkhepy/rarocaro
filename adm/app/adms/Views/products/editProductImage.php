    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 title">Editar Imagem do produto</h2>
            </div>
            <?php
            if (!empty($valorForm)) {
                extract($valorForm);
                ...
                <div class="p-2">
                    <span class="d-none d-lg-block">
                        ...
                        if ($this->dados['button']['edit_product_password']) {
                            echo "<a href='" . URLADM . "edit-product/index/$id' class='btn btn-outline-warning btn-sm'>Editar Senha</a> ";
                        }
                    ...
                    <div class="dropdown d-block d-lg-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                            ...
                            if ($this->dados['button']['list_product']) {
                                echo "<a class='dropdown-item' href='" . URLADM . "list-product/index'>Listar</a>";
                            }
                            if ($this->dados['button']['view_product']) {
                            ...
                            if ($this->dados['button']['edit_product_password']) {
                                echo "<a class='dropdown-item' href='" . URLADM . "edit-product-password/index/$id'>Editar Senha</a>";
                            }
                            if ($this->dados['button']['delete_product']) {
        ...
        <form id="edit_img" method="POST" action="" enctype="multipart/form-data">
            ...
            if (isset($valorForm['image']) AND (!empty($valorForm['image'])) AND (file_exists('app/adms/assets/image/products/' . $valorForm['id'] . '/' . $valorForm['image']))) {
                ...
                $old_image = URLADM . 'app/adms/assets/image/products/product_icon.png';
            }
            ?>
            ...
            <input name="EditProductImagem" type="submit" class="btn btn-outline-warning btn-sm" value="Salvar"> 
