...
<div class="content p-1">
    <div class="list-group-item">
                ...
                <div class="p-2">
                    ...
                    <div class="dropdown d-block d-lg-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                            <?php
                            if ($this->dados['button']['list_size']) {
                                echo "<a class='dropdown-item' href='" . URLADM . "list-sizes/index'>Listar</a>";
                            }
                            if ($this->dados['button']['view_size']) {
        ...
        <form id="form_size" method="POST" action="">
            ...
            <input name="EditSize" type="submit" class="btn btn-outline-warning btn-sm" value="Salvar"> 
