...
<div class="text-center d-block d-md-none pt-2 showImageDetail" id="showImageDetail"
  ...
  if(isset($this->dados['sts_homes']['relatedProductImages']) and !empty($this->dados['sts_homes']['relatedProductImages'])){
                foreach($this->dados['sts_homes']['relatedProductImages'] as $products){
                    extract($products);
...
const relatedProductImages = <?php echo json_encode($this->dados['sts_homes']['relatedProductImages']); ?>;
